...
const STUDENTS_DATA = [
  { firstName: "An",lastName:"Nguyen",batch:"G4" ,age: 20 },
  { firstName: "Bình",lastName:"Guk",batch:"G4", age: 22 },
  { firstName: "Cẩm",lastName:"Cerm",batch:"G4", age: 21 },
  { firstName: "An",lastName:"Luj",batch:"G4" ,age: 19 }, // Duplicate first name !
];
 ...
 * @param {string} batch - the sutdent batch
 */
...
updateStudentAge("An","Nguyen","G4", 30);
